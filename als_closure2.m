function [copt,sopt,sdopt,r2opt,itopt,solution]=als_closure2(d,x0,nexp,puntosMatrices,numexp,ExperimentRanges, nit,tolsigma,gr,isp,csel,ssel,vclos1,vclos2,constraints);
...
if datamod == 1
   ...
   nrinic(1)=1;
	...
	for i=1:matc,
        ...
        nrsol(i)=ExperimentRanges(i+1)-ExperimentRanges(i);
		nrfin(1)=nrsol(1);
      if i>1,
...
% 		disp(['S matrix, submatrix number ', num2str(i)]);
		ncsol(i)=ExperimentRanges(i+1)-ExperimentRanges(i);
		ncfin(1)=ncsol(1);
...
[conc2]=closure_multi(conc2,iclos(i),sclos1(i,:),iclos1(i),tclos1(i),tclos2(i),sclos2(i,:),iclos2(i),vclos1n,vclos2n);
end
conc(kinic:kfin,:)=conc2;
end
end
...
abst = closureModif(abss2',iclos(i),sclos1(i,:),iclos1(i),tclos1(i),tclos2(i),sclos2(i,:),iclos2(i),vclos1n,vclos2n);
abss2=abst';
end
abss(:,kinic:kfin) = abss2;
end
...
% outputfilename1 = sprintf('iter-%02d-%03d.dat',test,niter);
% dlmwrite (outputfilename1,abss')
% outputfilename2 = sprintf('iterconc-%02d-%03d.dat',test,niter);
% dlmwrite (outputfilename2,conc)
% ********************
