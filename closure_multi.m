...
% Here the stoichometry of the species needs to be defined
% in the same order as the defined initial estimates of
% curves. Therefore, the identity of the curves needs to be known
% before hand
sto1 = [1,1,1];
